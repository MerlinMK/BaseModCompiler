...
---@class ProfessionFramework
local ProfessionFramework = {
...
string type name of the profession
table details a table containing the profession details.
